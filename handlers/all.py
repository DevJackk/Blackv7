...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/BLACK_TEAM_4")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/T_V_P_E_BOT")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/BLACK_TEAM_4")]])
